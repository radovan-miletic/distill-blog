...
You may find the crumbs [here](https://github.com/radovan-miletic/distill-blog/tree/main/_posts/2022-01-24-the-toc-in-distill): `toc-styles.css` and `the-toc-in-distill.Rmd`. Hope they will be inspirational to someone.  

Judging by the {[distill](https://github.com/rstudio/distill)} issues [16](https://github.com/rstudio/distill/issues/16), [341](https://github.com/rstudio/distill/issues/341), [366](https://github.com/rstudio/distill/issues/366), [420](https://github.com/rstudio/distill/issues/420), and the Stack Overflow [question](https://stackoverflow.com/questions/67323162/floating-toc-in-distill-for-r) it seems that there is a genuine need for some kind of a "floating TOC on the side" in {distill}.  

In his [comment](https://github.com/rstudio/distill/issues/16#issuecomment-692207662), J.J. Allaire summarizes the problem:  
- any change in {distill} should be linked to [distll.pub](https://github.com/distillpub/template) web framework,  
...
You may disable the [z-index](https://developer.mozilla.org/en-US/docs/Web/CSS/z-index?) (previous section). If this is your preference, TOC will go underneath the figures.
...
You may disable the hover effect.
