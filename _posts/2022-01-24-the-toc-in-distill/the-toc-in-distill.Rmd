...
## Crumbs from a poor man's table
...
While we wait for a solution, you may may feel tempted to try "a poor man's TOC" hacky patchwork that I came up with for my use case (applied to single article).  
