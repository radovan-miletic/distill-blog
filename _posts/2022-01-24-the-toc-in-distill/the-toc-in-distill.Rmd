...
![Figure from https://www.wikigallery.org/wiki/painting_366127/William-Harris-Weatherhead/Crumbs-From-A-Poor-Man's-Table. William Harris Weatherhead (British 1843-1903), CRUMBS FROM A POOR MAN'S TABLE (Image)](images/painting1.jpg){width=70% .external}
...
Judging by the {distill} issues [16](https://github.com/rstudio/distill/issues/16), [341](https://github.com/rstudio/distill/issues/341), [366](https://github.com/rstudio/distill/issues/366), and the Stack Overflow question [here](https://stackoverflow.com/questions/67323162/floating-toc-in-distill-for-r) it seems that there is a genuine need for some kind of a floating TOC in {distill}.  
...
- any change in {distill} should be linked to [distll.pub](https://distill.pub/about/) article;  
